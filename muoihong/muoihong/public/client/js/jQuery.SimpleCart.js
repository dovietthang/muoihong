...
(function ($, window, document, undefined) {
    ...
    $.extend(simpleCart.prototype, {
        ...
        _updateCartDetails: function () {
            ...
            $(this.options.totalCartCostClass).html(mi._totalCartCost()+' đ');
            if(check_cart == 'pay'){
            ...
            for (var i in cartArray) {
                if(check_cart == 'cart'){
                    output +="<tr>\n\
                       ...
                       <td><i class='fa fa-dollar'>" + cartArray[i].price + "</i></td>\n\
                    ...
                    output += "<div class='cart-each-product row'>\n\
                       ...
                       <div class='quantity-am col-md-3'><i class='fa fa-dollar'>" + cartArray[i].price + "</i></div>\n\
                       </div>";
                }
            }
            return output;
